...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "  Start the daemon:  ${BOLD}./start.sh${NC}  (sources .env + seeds credentials)"
echo -e "  Check status:      ${BOLD}zeroclaw status${NC}"
echo -e "  Test via CLI:      ${BOLD}zeroclaw agent -m \"hello\"${NC}"
echo ""
echo -e "  ${YELLOW}!${NC} Always use ${BOLD}./start.sh${NC} instead of ${BOLD}zeroclaw daemon${NC} directly."
echo -e "    This ensures .env is sourced and credentials are seeded into memory."
echo ""
